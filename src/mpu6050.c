...
/*
	...
	3.3v (pin 36) -> VCC on MPU6050 board GND (pin 38) -> GND on MPU6050 board
*/
...
// Normalize acceleration and gyro values to g/s^2 and rad/s.
...
#warning Laplace requires a board with I2C pins
